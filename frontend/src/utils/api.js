...
export const submitCohortApplication = (data) => API.post("/cohort/book", data);
...
export const updateHireRequest = (id, data) =>
  API.patch(`/admin/hire-requests/${id}`, data);
export const getAdminUsers = (params) => API.get("/admin/users", { params });
export const getUserActivity = (userId) =>
  API.get(`/admin/users/${userId}/activity`);


export const getAdminCohortApplications = (params) =>
  API.get("/admin/cohort-applications", { params });

export const updateCohortStatus = (id, data) =>
  API.patch(`/cohort/book/${id}/status`, data);