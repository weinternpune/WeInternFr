...
# ============================================================
# WeIntern - Homepage sections polish (Problem / Ecosystem / LiveJourney)
# Light theme matching reference mockups, fully responsive.
# Run from your project ROOT:
#   cd ~/path/to/WeInternFr
#   bash polish-homepage-sections.sh
# ============================================================
...
echo "[1/2] Writing SectionsPolish.css ..."
...
@media (max-width: 900px) {
  .gap-visual { grid-template-columns: 1fr !important; }
...
.eco-step-circle svg { width: 26px !important; height: 26px !important; }
.eco-step-label { font-weight: 800 !important; font-size: 0.92rem !important; color: #14192e !important; }
.eco-step-desc { font-size: 0.76rem !important; color: #6b7280 !important; line-height: 1.4 !important; display: block !important; margin-top: 2px !important; }
.eco-step-arrow { color: #d1d5db !important; flex: 0 0 auto !important; }
...
.eco-bottom-inner {
  display: grid !important;
  grid-template-columns: 1.1fr auto 1.4fr !important;
  gap: 2rem !important;
  align-items: center !important;
}
.eco-b-heading { color: #fff !important; font-weight: 800 !important; font-size: 1.5rem !important; line-height: 1.3 !important; }
.eco-b-green { color: #4ade80 !important; }
.eco-b-sub { color: rgba(255,255,255,0.65) !important; font-size: 0.85rem !important; margin-top: 0.5rem !important; }
.eco-donut { position: relative !important; width: 130px !important; height: 130px !important; flex-shrink: 0 !important; }
...
.eco-donut-pct { color: #4ade80 !important; font-weight: 800 !important; font-size: 1.6rem !important; }
.eco-donut-lbl { color: rgba(255,255,255,0.6) !important; font-size: 0.6rem !important; text-align: center !important; line-height: 1.4 !important; font-weight: 600 !important; margin-top: 4px; }
...
@media (max-width: 1024px) {
  ...
  .eco-bottom-inner { grid-template-columns: 1fr !important; text-align: center !important; }
...
@media (max-width: 640px) {
  ...
  .eco-steps { flex-direction: column !important; align-items: stretch !important; }
  .eco-step-card { flex-direction: row !important; text-align: left !important; }
...
echo "[2/2] Importing it into Sections.jsx (after existing CSS imports, so it wins the cascade) ..."
python3 << 'PYEOF1'
...
if "import './SectionsPolish.css'" in content:
    ...
    print("   WARNING: could not find LiveJourney.css import line -- add the import manually:")
...
echo "   Check the homepage: Problem section, Ecosystem section, and Learn/Build/Grow cards."
echo "   Resize the browser (or use DevTools device toolbar) to check tablet and mobile views."
echo ""
echo "To deploy:"
echo "   git add ."
echo "   git commit -m \"style: polish homepage sections (problem/ecosystem/journey) to light theme, responsive\""
