...
# ============================================================
# WeIntern - Homepage sections polish v3 (smaller donut, responsive)
# Run from your project ROOT:
#   cd ~/path/to/WeInternFr
#   bash polish-homepage-sections-v3.sh
# ============================================================
...
echo "Overwriting SectionsPolish.css (donut shrunk to 84px desktop / 68px mobile) ..."
...
.eco-bottom-inner {
  display: grid !important;
  grid-template-columns: 1.15fr 84px 1.35fr !important;
  gap: 1.75rem !important;
  align-items: center !important;
}
...
.eco-donut { position: relative !important; width: 84px !important; height: 84px !important; max-width: 84px !important; max-height: 84px !important; flex-shrink: 0 !important; margin: 0 auto !important; }
.eco-donut-svg { width: 100% !important; height: 100% !important; display: block !important; }
...
.eco-donut-pct { color: #4ade80 !important; font-weight: 800 !important; font-size: 1rem !important; line-height: 1 !important; }
.eco-donut-lbl { color: rgba(255,255,255,0.6) !important; font-size: 0.42rem !important; text-align: center !important; line-height: 1.25 !important; font-weight: 700 !important; margin-top: 2px; letter-spacing: 0.01em !important; }
...
@media (max-width: 640px) {
  ...
  .eco-donut { width: 68px !important; height: 68px !important; max-width: 68px !important; max-height: 68px !important; }
  .eco-donut-pct { font-size: 0.82rem !important; }
  .eco-donut-lbl { font-size: 0.36rem !important; }
}
...
echo ""
echo "IMPORTANT: if your dev server (npm start) is still running from before,"
echo "stop it (Ctrl+C) and restart it now -- CRA sometimes caches CSS changes"
echo "and won't show the new smaller size until a fresh restart + hard refresh"
echo "(Cmd+Shift+R) in the browser."
echo ""
echo "Next steps:"
echo "   cd frontend && npm start"
echo "   Hard refresh the page (Cmd+Shift+R) and check the donut size."
echo ""
echo "To deploy:"
echo "   git add ."
echo "   git commit -m \"fix: shrink 75% donut further, responsive sizing per breakpoint\""
